  ...
  <div class="dimension">
    <template>
      ...
      >
        ...
        <el-table-column prop="name" label="排放流量(m³/s)" min-width="100">
        ...
        <el-table-column prop="name" label="距下断面位置(m)" min-width="120">
          <template slot-scope="scope">
                <el-input
                  v-if="
                    scope.row.index === tabRowIndex &&
        ...
        <el-table-column prop="name" label="距岸边(m)" min-width="90">
          <template slot-scope="scope">
                <el-input
                  v-if="
                    scope.row.index === tabRowIndex &&
        ...
        <el-table-column prop="name" label="速率（g/s）" min-width="80">
        <template slot-scope="scope">
                <el-input
                  v-if="
                    scope.row.index === tabRowIndex &&
        ...
        <el-table-column prop="max" label="进水流量(m³/s)" min-width="100">
        <template slot-scope="scope">
                <el-input
                  v-if="
                    scope.row.index === tabRowIndex &&
        ...
        <el-table-column prop="mix" label="进水浓度(mg/l)" min-width="100">
        <template slot-scope="scope">
                <el-input
                  v-if="
                    scope.row.index === tabRowIndex &&
        ...
        <el-table-column prop="name" label="流速(m/s)" min-width="80">
        <template slot-scope="scope">
                <el-input
                  v-if="
                    scope.row.index === tabRowIndex &&
        ...
        <el-table-column prop="mix" label="系数横向扩散系数" min-width="170">
          <template slot-scope="scope">
                <el-input
                  v-if="
                    scope.row.index === tabRowIndex &&
