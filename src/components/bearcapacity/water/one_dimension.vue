  ...
  <div class="dimension">
    <template>
      ...
      >
        ...
        <el-table-column prop="address" label="排放流量(m³/s)" min-width="100">
         <template slot-scope="scope">
                <el-input
                  v-if="
                    scope.row.index === tabRowIndex &&
        ...
        <el-table-column prop="max" label="排放浓度(mg/l)" min-width="100">
         <template slot-scope="scope">
                <el-input
                  v-if="
                    scope.row.index === tabRowIndex &&
        ...
        <el-table-column prop="name" label="排放口距评价断面位置(m)" min-width="180">
           <template slot-scope="scope">
                <el-input
                  v-if="
                    scope.row.index === tabRowIndex &&
        ...
        <el-table-column prop="name" label="降解系数" min-width="100">
           <template slot-scope="scope">
                <el-input
                  v-if="
                    scope.row.index === tabRowIndex &&
        ...
        <el-table-column prop="mix" label="河长(m)" min-width="80">
           <template slot-scope="scope">
                <el-input
                  v-if="
                    scope.row.index === tabRowIndex &&
