  ...
  <div class="content">
      ...
      <div class="navigation">
        ...
        <div class="nav">
          <ul class="clear-fix nav_ui">
            <li :class="[companyType=='1'?'cur':'']" @click="companySwitch(1)">河长制</li>
            <li :class="[companyType=='2'?'cur':'']" @click="companySwitch(2)">流域</li>
            <li :class="[companyType=='3'?'cur':'']" @click="companySwitch(3)">水资源</li>
        ...
        <dl>
          <dt>
            <ul class="clear-fix radio_static">
              ...
              <li :class="[status=='3'?'cures':'']" @click="condition(3)">一维MIKE</li>
              <li :class="[status=='4'?'cures':'']" @click="condition(4)">二维</li>
              <li @click="close()">
      ...
      <div class="Mouth" v-show="radio_static == 2">
        ...
        <dl>
          <dt>
            <ul class="clear-fix radio_static">
              <li :class="[status=='1'?'cures':'']" @click="condition(1)">一维</li>
              <li :class="[status=='2'?'cures':'']" @click="condition(2)">一维MIKE</li>
              <li @click="close()">
                <img src="../../../static/images/close.png" alt="">
              </li>
            </ul>
        ...
        <dl>
          <dt>
            <ul class="clear-fix radio_static">
              ...
              <li :class="[status=='6'?'cures':'']" @click="condition(6)">分层</li>
              <li @click="close()">
                <img src="../../../static/images/close.png" alt="">
              </li>
            </ul>
