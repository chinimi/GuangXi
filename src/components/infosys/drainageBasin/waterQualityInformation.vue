    ...
    <div class="sheet">
      <div class="table">
        ...
        >
          ...
          <el-table-column prop="EndDate" label="测站种类（经纬度）"></el-table-column>
          <el-table-column prop="CertNum" label="所属市"></el-table-column>
          <el-table-column prop="PublishDateTime" label="所属水系"></el-table-column>
