    ...
    <div class="programmePreparation_right">
      ...
      <div>
        ...
        >
          ...
          <el-table-column prop="ScenarioCode" label="模板编码" min-width="100">
          </el-table-column>
          <el-table-column prop="ScenarioName" label="模板名称" min-width="100">
          </el-table-column>
          ...
          <el-table-column prop="WaterResource_ZoneName" label="水资源分区" min-width="130">
          </el-table-column>
